...
print(f"3. Iniciando Enriquecimiento de Taxonomía y Descripciones...")
...
for index, row in df_kaiqi.iterrows():
    ...
    sistema, subsistema, componente = "ACCESORIOS Y OTROS", "VARIOS", categoria_kaiqi_orig.title()
    ...
    df_kaiqi.at[index, 'Tipo Vehiculo'] = get_tipo_vehiculo(desc_final_pulida)
