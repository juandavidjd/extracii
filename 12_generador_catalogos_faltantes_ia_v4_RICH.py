...
def analizar_imagen_profundo(ruta_img, nombre_ref=""):
    ...
    try:
        ...
        {{
            ...
            "Caracteristicas_Observadas": "Descripción visual breve (material, color, forma)",
            "Compatibilidad_Probable_Texto": "Motos compatibles sugeridas",
            "Funcion": "Para qué sirve brevemente",
            "Tags_Sugeridos": "tag1, tag2, tag3",
            "Notas_Sobre_Textos_Grabados": "Si ves códigos en el metal"
        }}
        """
...
if __name__ == "__main__":
    print("--- GENERADOR V12.4: CATÁLOGOS RICOS (NIVEL BARA) ---")
    for lote in LOTES:
        procesar_lote(lote)