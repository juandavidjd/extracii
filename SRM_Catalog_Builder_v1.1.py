# ======================================================================
#               SRM_Catalog_Builder_v1.1.py (FIXED + PRO READY)
#     CONSTRUCTOR OFICIAL DEL CATÁLOGO UNIFICADO SRM v1.1
# ======================================================================
# Mejoras v1.1:
#   ✔ Compatibilidad keyword / keywords
#   ✔ Manejo robusto de taxonomía
...
# ----------------------------------------------------------------------
# TAXONOMY MATCHER (v1.1 FIX)
# ----------------------------------------------------------------------
def classify_taxonomy(desc, taxo_df):

    desc = desc.lower().strip()

    # Determinar columna keyword / keywords
    if "keyword" in taxo_df.columns:
        key_col = "keyword"
    elif "keywords" in taxo_df.columns:
        key_col = "keywords"
    else:
        return "", "", "", ""
...
def build_sku_srm(marca, codigo, index):
    marca = (str(marca).upper()[:3]) if isinstance(marca, str) else "GEN"
...
def build_fitment(df):
    ...
    for _, row in df.iterrows():
        ...
        # Fitment básico (v2 incorporará Fitment Japan)
        modelo = ""
        cilindraje = ""
...
def run():
    ...
    print("\n===============================================")
    print("       SRM — CATALOG BUILDER v1.1 (PRO FIX)")
    print("===============================================\n")
    ...
    print("\n===============================================")
    print(" ✔ CATALOGO SRM v1.1 COMPLETADO")
    print("===============================================\n")
